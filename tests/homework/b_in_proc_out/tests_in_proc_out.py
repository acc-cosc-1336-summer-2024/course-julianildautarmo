...
# The file at /src/homework/b_in_proc_out/output has the function get_number.
...
class Test_Config(unittest.TestCase):
    ...
    def test_multiply_numbers_1(self):
        #test that the function returns 5*5=25
        self.assertEqual(25, multiply_numbers(5,5))
    
    def test_multiply_numbers_2(self):
        #test that the function returns 10*10=100
